...
####################################################
##          Parse JSON file with variables        ##
####################################################

case_vars_dict = {}

if os.path.isfile('./case_vars.json'):
  with open('./case_vars.json') as json_file:
    case_vars_dict = json.load(json_file)
elif os.path.isfile('./case_vars.example.json'):
  with open('./case_vars.example.json') as json_file:
    case_vars_dict = json.load(json_file)
else:
  print("####################################################")
...
print("case_vars_dict", case_vars_dict)


####################################################
##       Begin of NoteBook variables section      ##
####################################################
notebook.set("field_length", case_vars_dict['field_length'])
...
geomObj_1 = geompy.MakeBoxDXDYDZ("field_length", "field_height", "field_width")
